...
const Footer = async () => {
    const repoStats = await fetch(
        'https://api.github.com/repos/Uchiha-byte/portfolio-2.0',
        {
            next: {
        ...
        <footer className="text-center pb-5" id="contact">
            <div className="container">
                ...
                <div className="">
                    ...
                    >
                        Design & built by Ans Ahmed Khan
